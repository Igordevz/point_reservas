...
export default function AsideBar() {
  ...
  return (
    <aside className="fixed w-[23%] h-full  rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-0  z-10 hidden border-r-[1px] transition-all md:flex flex-col justify-between overflow-hidden hover:w-[30%] ">
      <div>
